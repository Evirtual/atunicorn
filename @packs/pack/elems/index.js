...
const Button = Actheme.create({
  ...
  Elem: ({text, source, info, size, icon, solid, iconColor, iconSize, imageWidth, imageHeight, fontSize, textColor, spin, post, disabled, nsfw, inline, onPress, ...props}) => {
    return <Button.Touch info={info} post={post} nsfw={nsfw} inline={inline} disabled={disabled} spin={spin} onPress={!disabled ? onPress : null} {...props}>
